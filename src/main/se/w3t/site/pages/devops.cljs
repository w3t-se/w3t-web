  ...
  (g/container {:spacing 6}
               ...
               (g/item {:xs 8}
                       (l/stack {:direction :row
                                 ...
                                 :spacing 3
                                 :style {:color "#b2b4bf"}}
                                (h2 "DEVELOPERS") (h2 "CODE") (h2 "PIPELINES") (h2 "ARTIFACTS") (h2 "INFRA"))
...
We believe DevOps is about the merging of Team Development Processes, Build Tooling and Pipeline Automation,
Code structuring and modularization into Artifacts and of course choosing a modern IT Infrastructure that fully
 supports GitOps as well as Infrastucture and Configuration as Code Concepts.

<img src=\"/images/venn.svg\" alt=\"dra\" width=\"30rem\">"}))
               (g/item {:xs 3}
